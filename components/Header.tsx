export default () => {
	return (
		<nav class="border-gray-200 dark:border-gray-700 sticky h-24 top-0 z-[1] bg-gradient-to-r from-red-900 via-slate-400 to-blue-900">
			<div class="max-w-screen grid md:grid-cols-5 grid-cols-4 h-24 flex p-4 bg-[url('/images/congress.jpg')] bg-right bg-cover mix-blend-overlay justify-center items-end">
